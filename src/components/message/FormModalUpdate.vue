        ...
        >
          ...
          >
            ...
            <div class="w-full px-5 bg-blueGray-200">
              <form @submit.prevent="update" v-if="message.data">
                <div class="relative w-full mb-3">
                  ...
                  <input
                    v-model="message.data.code"
                    type="text"
                    class="w-full text-sm transition-all duration-150 ease-linear border-0 rounded shadow  bg-blueGray-200 placeholder-blueGray-300 text-blueGray-800"
                    readonly
                  />
...
const message = computed(() => {
  return store.getters["message/getStateMessage"];
});
const update = () => {
  ...
  store
    .dispatch("message/updateData", {
      id: message.value.data.id,
      code: message.value.data.code,
