      ...
      <div class="w-full px-4 mx-auto -m-28 md:px-10">
        <div class="flex flex-wrap mt-4">
          <div class="w-full px-4 mb-12">
            <div
              class="relative flex flex-col w-full min-w-0 break-words rounded shadow-lg  bg-blueGray-200"
            >
              <div class="block w-full overflow-x-auto">
                <!-- Projects table -->
                <table
                  class="items-center w-full border-collapse bg-bluGray-300"
                >
                  <thead>
                    <tr>
                      <th
                  ...
                  <tbody class="break-all">
                    ...
                    <tr v-for="(items, index) in clients.data" :key="index">
                      <td
                        class="p-5 px-4 text-xs align-middle border-t-0 border-l-0 border-r-0  whitespace-nowrap"
                      >
                        {{ index + 1 }}
                      </td>
                      <th
                        class="flex items-center p-5 px-4 text-xs text-left align-middle border-t-0 border-l-0 border-r-0  whitespace-nowrap"
                      >
...
import { UserAddIcon, TrashIcon, PencilIcon } from "@heroicons/vue/outline";
