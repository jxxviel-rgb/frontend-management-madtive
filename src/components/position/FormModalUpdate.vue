        ...
        >
          ...
          >
            ...
            <div class="w-full px-5 bg-blueGray-200">
              <form @submit.prevent="update" v-if="position.data.data">
                <div class="relative w-full mb-3">
                  ...
                  <input
                    v-model="position.data.data.position_name"
                    type="text"
...
export default {
  ...
  setup(props, { emit }) {
    ...
    const update = () => {
      ...
      store
        .dispatch("position/updateData", {
          position_name: position.data.data.position_name,
